...
export const KnowledgeGapCard: React.FC<KnowledgeGapCardProps> = ({ gaps }) => {
  ...
  return (
    <div className="w-full bg-[#161b22] border border-red-500/20 rounded-xl p-6 shadow-inner">
      <h4 className="text-sm font-bold text-red-400 mb-4 flex items-center gap-2">
        <span>⚠️</span> Vacíos de Conocimiento
      </h4>
      <p className="text-xs text-white/60 mb-4">
        Los siguientes campos no han podido ser inferidos. Su ausencia afectará la precisión de los insights generados.
      </p>
